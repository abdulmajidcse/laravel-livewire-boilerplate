<span class="nav-link" {{ $attributes->merge() }}>
    <i class="fas fa-adjust theme-icon" id="switch_to_dark_theme" title="Switch to dark mode" role="button"
        onclick="setTheme('dark')"></i>
    <i class="fas fa-sun theme-icon" id="switch_to_os_theme" title="Switch to system mode" role="button"
        onclick="setTheme('os')"></i>
    <i class="fas fa-moon theme-icon" id="switch_to_light_theme" title="Switch to light mode" role="button"
