...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        ...
        <i class="fas fa-home brand-image img-circle elevation-3" style="opacity: .8; float: none;"></i>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <x-auth.sidebar-menu href="#" icon="fas fa-th" text="Starter Pages" :dropdown="true">
